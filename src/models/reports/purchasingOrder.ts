    ...
    getReservedOrdered(db: Knex, reserve_id) {
        let sql = db('pc_product_reserved as rv')
            .select('mg.working_code', 'mp.product_name', 'mg.generic_id', 'rv.contract_id',
                ...
                'ug.qty as conversion_qty', 'ug.standard_cost', 'ml.labeler_name', 'ml.nin', 'gt.generic_type_name', 'vcpa.contract_id', 'vcpa.contract_no', 'mp.tmt_id', 'mp.std_code', 'mp.description')
